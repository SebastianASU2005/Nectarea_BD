  ...
  async registrarFirma(req, res) {
    try {
      const {
        ...
        codigo_2fa,
        id_inversion, // NUEVO: opcional
        id_suscripcion, // NUEVO: opcional
      } = req.body;
      ...
      // ============================================================
      // FASE 4: PRE-VALIDACIÓN DE NEGOCIO (incluye selección explícita)
      // ============================================================
      ...
      // ============================================================
      // FASE 5: GUARDAR PDF (solo si las validaciones pasaron)
      // ============================================================
      const sanitize = (str) =>
      ...
      const firmaData = {
        ...
        id_inversion, // opcional
        id_suscripcion, // opcional
      };
