...
const cuotaMensualService = {
  ...
  _calculateValues(data) {
    ...
    const valor_mensual = total_del_plan / data.total_cuotas_proyecto; // Cuota Pura

    // CAMBIO AQUÍ: Calcular sobre valor_mensual en lugar de valor_movil
    const carga_administrativa =
      valor_mensual * (porcentaje_administrativo / 100);
    ...
    return {
      ...
      valor_mensual_final: parseFloat(valor_mensual_final.toFixed(2)), // ESTE es el que envías a MP
    };
  },
